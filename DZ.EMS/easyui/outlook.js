...
//	});
	...
	var navlist = $.cookie("leftnav");//读取cookie 中左边菜单
	if (navlist) {
	    addNav($.parseJSON(navlist));
	} else {
	  //  addNav(_menus["basic"]);
	}
	...
	$.each(data, function(i, sm) {
		...
		$.each(sm.menus, function(j, o) {
		    menulist += '<li><div><a ref="' + o.menuid + '" href="javascript:void(0)" rel="'
					+ o.url + '" ><span class="icon ' + 'icon-nav'//o.icon
